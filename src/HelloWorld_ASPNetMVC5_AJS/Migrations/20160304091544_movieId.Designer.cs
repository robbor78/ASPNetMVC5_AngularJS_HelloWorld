...
namespace HelloWorld_ASPNetMVC5_AJS.Migrations
{
    ...
    [Migration("20160304091544_movieId")]
    partial class movieId
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("HelloWorld_ASPNetMVC5_AJS.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HelloWorld_ASPNetMVC5_AJS.Models.ApplicationUser")
                        .WithMany()
